    ...
    public function getClaimById(int $id, int $districtCode = null)
    {
        return $this->claim->query()
            ...
            ->select([
                ...
                DB::raw("(CASE WHEN claims.property_owner = '2' THEN claims.ind_name ELSE claims.ind_name END) as property_owner"),
                DB::raw("(CASE WHEN claims.property_owner = '2' THEN claims.ind_pinfl ELSE claims.ind_pinfl END) as property_tin"),
