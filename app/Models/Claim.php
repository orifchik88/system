...
class Claim extends Model
{
    ...
    {
        return $this->belongsTo(Article::class, 'object_id', 'id')->with(['region', 'district', 'users', 'program'])
            ->select('id', 'name', 'location_building', 'region_id', 'district_id', 'lat', 'long', 'object_type_id', 'price_supervision_service', 'sphere_id', 'difficulty_category_id');
    }
